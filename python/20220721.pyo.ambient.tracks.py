...
# # Full drone
# oscs = [
#     Pad(note=root     , bw=40, damp=dampFactor*0.9, cutoff=cutoff, reverb=.9, phase=phase, mul= volumeA * 0.800), #  0.546   0.000
#     Pad(note=root+12  , bw=40, damp=dampFactor*0.8, cutoff=cutoff, reverb=.9, phase=phase, mul= volumeA * 0.800), #  0.542   0.000
#     Pad(note=root+24  , bw=40, damp=dampFactor*0.8, cutoff=cutoff, reverb=.9, phase=phase, mul= volumeA * 0.326), #  0.204   0.000
#     Pad(note=root+24+7, bw=40, damp=dampFactor*0.8, cutoff=cutoff, reverb=.9, phase=phase, mul= volumeA * 0.123), #  0.077   0.000
#     Pad(note=root+36  , bw=70, damp=dampFactor*0.6, cutoff=cutoff, reverb=.9, phase=phase, mul= volumeA * 0.179), #  0.112   0.065
#     Pad(note=root+36+7, bw=70, damp=dampFactor*0.6, cutoff=cutoff, reverb=.9, phase=phase, mul= volumeA * 0.056), #  0.035   0.023
#     Pad(note=root+48  , bw=70, damp=dampFactor*0.6, cutoff=cutoff, reverb=.9, phase=phase, mul= volumeA * 0.080), #  0.050   0.073
#     Pad(note=root+48+7, bw=70, damp=dampFactor*0.5, cutoff=cutoff, reverb=.9, phase=phase, mul= volumeA * 0.030), #  0.019   0.042
#     Pad(note=root+60  , bw=70, damp=dampFactor*0.4, cutoff=cutoff, reverb=.9, phase=phase, mul= volumeA * 0.067), #  0.042   0.027
#     Pad(note=root+60+7, bw=70, damp=dampFactor*0.3, cutoff=cutoff, reverb=.9, phase=phase, mul= volumeA * 0.019), #  0.012   0.023
#     Pad(note=root+72  , bw=70, damp=dampFactor*0.3, cutoff=cutoff, reverb=.9, phase=phase, mul= volumeA * 0.040), #  0.042   0.027
#     Pad(note=root+72+7, bw=70, damp=dampFactor*0.3, cutoff=cutoff, reverb=.9, phase=phase, mul= volumeA * 0.010), #  0.012   0.023
...
#     ToneBeatSimple(note=root+36, dur=dt, decay=.12, sustain=.0,    reverb=.9, mul= volumeB * 0.012, tone=[1., .4, .2, .1, .05]), #  0.069   0.000
#     ToneBeatSimple(note=root+48, dur=dt, decay=.12, sustain=.0,    reverb=.9, mul= volumeB * 0.008, tone=[1., .4, .2, .1, .05]), #  0.069   0.000
# ]
...
oscs = [
    ...
    ToneBeatSimple(note=root+24, dur=dt, decay=.12, sustain=.0,    reverb=.9, mul= volumeB * 0.020, tone=[1., .8, .4, .2, .05]), #  0.069   0.000
    ToneBeatSimple(note=root+36, dur=dt, decay=.12, sustain=.0,    reverb=.9, mul= volumeB * 0.010, tone=[1., .4, .2, .1, .05]), #  0.069   0.000
    ToneBeatSimple(note=root+48, dur=dt, decay=.12, sustain=.0,    reverb=.9, mul= volumeB * 0.006, tone=[1., .4, .2, .1, .05]), #  0.069   0.000
]
...
def printInfos():
    [print("{:.3f}".format(osc.amp.value.value)) if hasattr(osc.amp.value, 'value') else print("{:.3f}".format(osc.amp.value)) for osc in oscs]
    # print("{:.3f}".format(coef.value.value)) if hasattr(coef.value, 'value') else print("{:.3f}".format(coef.value))
    # [print("{:.3f}".format(v.value)) for v in mixvol]
    print("-")

pool = Pattern(printInfos, .5)
pool.play()
